...
// Задание 4: Яркость (R = (r * k + c) mod 256)
...
// Задание 5: Контраст (Интерполяция [n, c] -> [1, 254])
...
// --- ТОЧКА ВХОДА (WinMain) - ЭТО ИСПРАВЛЯЕТ ОШИБКУ LNK2019 ---
